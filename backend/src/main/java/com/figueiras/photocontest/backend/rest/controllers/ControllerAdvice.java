...
public class ControllerAdvice {
    ...
    @ResponseStatus(HttpStatus.NOT_FOUND)
    @ResponseBody
    public ErroresDto manejarExcepcionInstanceNotFound(CategoriaDuplicadaException e, Locale locale){

        String mensajeExcepcion = messageSource.getMessage(CATEGORIA_DUPLICADA_EXCEPTION_CODE,
               null , CATEGORIA_DUPLICADA_EXCEPTION_CODE, locale);
